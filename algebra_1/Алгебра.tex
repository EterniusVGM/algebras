...
\usepackage[left=0.5cm, right=0.5cm, top=0.5cm, bottom=0.5cm]{geometry} % Изменение размеров полей
...
\addcontentsline{toc}{section}{Примитивные многочлены. Лемма Гаусса. Факториальность колец многочленов.}
